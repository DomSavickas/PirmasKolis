...
class third:  # Sukūriama klasė third
    def check_input(self):  # Sukūriama funkcija list_filtration, kuri skirta filtravimui
        try:
            ...
            if (0 > y and len(x) % y != 0):  # Patikra ar yra įmanoma
                ...
                while (y <= len(x)):  # Pradedama while ciklas, kuris suksis tol kol bus y mažiau arba lygu x
